...
class CrossModuleStackTraceTest {
    ...
    @Test
    fun errorInModuleShowsModuleName() = engineTest {
        it.compile(
            """
    ...
    @Test
    fun errorInModuleShowsScriptName() = engineTest {
        it.compile(
            """
    ...
    @Test
    fun stackTraceCrossModuleChain() = engineTest {
        it.compile(
            """
    ...
    @Test
    fun stackTraceMultiModuleChain() = engineTest {
        it.compile(
    ...
    @Test
    fun referenceErrorFromModule() = engineTest {
        it.compile(
            """
    ...
    @Test
    fun typeErrorFromModule() = engineTest {
        it.compile(
            """
    ...
    @Test
    fun stackTraceThroughReexportedFunction() = engineTest {
        it.compile(
    ...
    @Test
    fun stackTraceThroughAggregatingExport() = engineTest {
        it.compile(
            """
    ...
    @Test
    fun stackTraceClassFromModule() = engineTest {
        it.compile(
            """
    ...
    @Test
    fun stackTraceClassExtendsAcrossModule() = engineTest {
        it.compile(
            """
    ...
    @Test
    fun stackTraceCommonJSModule() = engineTest {
        it.compile(
            """
    ...
    @Test
    fun stackTraceCommonJSAndESMMix() = engineTest {
        it.compile(
            """
    ...
    @Test
    fun errorDuringModuleEvaluation() = engineTest {
    ...
    @Test
    fun errorThrownFromModuleCaughtInMain() = engineTest {
        it.compile(
            """
    ...
    @Test
    fun stackTraceThroughEvalInModule() = engineTest {
        it.compile(
            """
    ...
    @Test
    fun stackTraceModuleFunctionCallingLocalFunction() = engineTest {
        it.compile(
            """
    ...
    @Test
    fun stackTraceLocalFunctionCallingModuleFunction() = engineTest {
        it.compile(
            """
    ...
    @Test
    fun moduleErrorHasScriptNameInProperties() = engineTest {
        it.compile(
            """
    ...
    @Test
    fun stackTraceDefaultExportFunction() = engineTest {
        it.compile(
            """
    ...
    @Test
    fun moduleResetClearsCallStack() = engineTest {
        it.compile(
            """
