...
internal class JSArrayFunction : JSFunction(
    ...
    init {
        ...
        val proto = JSObjectImpl().apply {
            this["length"] = JsNumberWrapper(0)
            this["indexOf"] = IndexOf(mutableListOf())
            this["lastIndexOf"] = LastIndexOf(mutableListOf())
            this["forEach"] = ForEach(mutableListOf())
            this["map"] = Map(mutableListOf())
            this["filter"] = Filter(mutableListOf())
            this["reduce"] = Reduce(mutableListOf())
            this["reduceRight"] = ReduceRight(mutableListOf())
            this["some"] = Some(mutableListOf())
            this["every"] = Every(mutableListOf())
            this["reverse"] = Reverse(mutableListOf())
            this["toReversed"] = ToReversed(mutableListOf())
            this["sort"] = Sort(mutableListOf())
            this["toSorted"] = ToSorted(mutableListOf())
            this["slice"] = Slice(mutableListOf())
            this["splice"] = Splice(mutableListOf())
            this["toSpliced"] = ToSpliced(mutableListOf())
            this["at"] = At(mutableListOf())
            this["includes"] = Includes(mutableListOf())
            this["join"] = Join(mutableListOf())
            this["push"] = Push(mutableListOf())
            this["pop"] = Pop(mutableListOf())
            this["shift"] = Shift(mutableListOf())
            this["unshift"] = Unshift(mutableListOf())
            this["concat"] = Concat(mutableListOf())
            this["copyWithin"] = CopyWithin(mutableListOf())
            this["flat"] = Flat(mutableListOf())
            this["flatMap"] = FlatMap(mutableListOf())
        }
//        setProto(proto)
        setPrototype(proto)
    }
