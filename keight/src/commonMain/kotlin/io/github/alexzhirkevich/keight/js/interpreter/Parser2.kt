...
//import io.github.alexzhirkevich.keight.expressions.OpLogicalAnd
//import io.github.alexzhirkevich.keight.expressions.OpLogicalOr
...
//}
//
////private fun ListIterator<Token>.parseStatement2(
...
//    var x = receiver
//
//    fun stepForward(bt: ExpectedBlockType? = null) : Expression {
//        return parseStatement(x, blockContext, precedence - 1, bt ?: blockType)
//    }
//
//    fun next(bt: ExpectedBlockType? = null) : Expression {
//        return parseStatement(null, blockContext, precedence - 1, bt ?: blockType)
//    }
//
//    fun nextRight(bt: ExpectedBlockType? = null) : Expression {
//        return parseStatement(null, blockContext, precedence, bt ?: blockType)
//    }
//
//    while (true) {
//        x = when (precedence) {
...
//                x != null -> return x
//                // EXPRESSION GROUPING
//                nextIsInstance<Token.Operator.Bracket.RoundOpen>() ->
//                    return parseExpressionGrouping()
//
//                else -> return parseFactor(blockContext, blockType)
//            }
//            1 /*17*/ -> if (x != null) {
...
//            }
//            3 /*15*/ -> if (x != null) {
//                return when (val it = nextSignificant()) {
...
//                    is Token.Operator.Arithmetic.Inc,
//                    is Token.Operator.Arithmetic.Dec -> {
//                        val v = nextRight(ExpectedBlockType.Object)
//                        syntaxCheck(v.isAssignable()) {
//                            "Value is not assignable"
//                        }
//                        OpIncDecAssign(
//                            variable = v,
...
//                    }
//                    // LOGICAL NOT
//                    Token.Operator.Logical.Not -> OpNot(nextRight(ExpectedBlockType.Object))
//                    // BITWISE NOT
//                    Token.Operator.Bitwise.Reverse -> {
//                        val expr = nextRight(ExpectedBlockType.Object)
//                        Expression {
...
//                    Token.Operator.Arithmetic.Minus -> Delegate(
//                        a = nextRight(ExpectedBlockType.Object),
//                        op = if (it is Token.Operator.Arithmetic.Plus)
//                            ScriptRuntime::pos else ScriptRuntime::neg
//                    )
//                    // TYPEOF
//                    is Token.Operator.Typeof -> parseTypeof()
//                    // VOID
//                    is Token.Operator.Void -> TODO("void")
//                    // DELETE
...
//                    Token.Operator.Arithmetic.Exp -> OpExp(
//                        x = x,
//                        degree = nextRight(ExpectedBlockType.Object)
//                    )
//                    else -> x.also { prevSignificant() }
//                }
//            } else {
...
//                    // MULTIPLICATION
//                    Token.Operator.Arithmetic.Mul -> Delegate(
//                        x, next(ExpectedBlockType.Object), ScriptRuntime::mul
//                    )
//                    // DEVISION
//                    Token.Operator.Arithmetic.Div -> Delegate(
//                        x, next(ExpectedBlockType.Object), ScriptRuntime::div
//                    )
//                    // DIVISION REMINDER
//                    Token.Operator.Arithmetic.Mod -> Delegate(
//                        x, next(ExpectedBlockType.Object), ScriptRuntime::mod
//                    )
//                    else -> x.also { prevSignificant() }
//                }
//            } else {
...
//                    Token.Operator.Arithmetic.Plus -> Delegate(
//                        x, next(ExpectedBlockType.Object), ScriptRuntime::sum
//                    )
//                    // SUBTRACTION
//                    Token.Operator.Arithmetic.Minus -> Delegate(
//                        x, next(ExpectedBlockType.Object), ScriptRuntime::sub
//                    )
//                    else ->  x.also { prevSignificant() }
//                }
//            } else {
...
//                    // SHIFT LEFT
//                    Token.Operator.Bitwise.Shl -> OpLongInt(
//                       x, next(ExpectedBlockType.Object), Long::shl
//                    )
//                    // SHIFT RIGHT (SIGNED)
//                    Token.Operator.Bitwise.Shr -> OpLongInt(
//                        x, next(ExpectedBlockType.Object),Long::shr
//                    )
//                    // SHIFT RIGHT (UNSIGNED)
//                    Token.Operator.Bitwise.Ushr -> OpLongInt(
//                        x, next(ExpectedBlockType.Object), Long::ushr
//                    )
//                    else ->  x.also { prevSignificant() }
//                }
//            } else {
...
//                    Token.Operator.Instanceof -> parseInstanceOfOperator(x, precedence)
//                    // LESS THAN
//                    Token.Operator.Compare.Less ->
//                        OpCompare(x, nextRight(ExpectedBlockType.Object)){ it < 0 }
//                    // LESS THAN OR EQUAL
//                    Token.Operator.Compare.LessOrEq ->
//                        OpCompare(x, nextRight(ExpectedBlockType.Object)){ it <= 0 }
//                    // GREATER THAN
//                    Token.Operator.Compare.Greater ->
//                        OpCompare(x, nextRight(ExpectedBlockType.Object)){ it > 0 }
...
//                    // EQUAL
//                    Token.Operator.Compare.Eq -> OpEquals(
//                        x, nextRight(ExpectedBlockType.Object), false
//                    )
//                    // STRICT EQUAL
//                    Token.Operator.Compare.StrictEq -> OpEquals(
//                        x, nextRight(ExpectedBlockType.Object), true
//                    )
//                    // UNEQUAL
//                    Token.Operator.Compare.Neq -> OpNotEquals(
//                        x, nextRight(ExpectedBlockType.Object), false
...
//                    // BITWISE AND
//                    Token.Operator.Bitwise.And -> OpLongLong(
//                        x, nextRight(ExpectedBlockType.Object), Long::and
//                    )
//                    else -> x.also { prevSignificant() }
//                }
//            } else {
...
//                    // BITWISE XOR
//                    Token.Operator.Bitwise.Xor -> OpLongLong(
//                        x, nextRight(ExpectedBlockType.Object), Long::xor
//                    )
//                    else -> x.also { prevSignificant() }
//                }
//            } else {
...
//                    // BITWISE OR
//                    Token.Operator.Bitwise.Or -> OpLongLong(
//                        x, nextRight(ExpectedBlockType.Object), Long::or
//                    )
//                    else -> x.also { prevSignificant() }
//                }
//            } else {
...
//                    // LOGICAL AND
//                    Token.Operator.Logical.And ->
//                        OpLogicalAnd(x, nextRight(ExpectedBlockType.Object))
//                    else -> x.also { prevSignificant() }
//                }
//            } else {
//                 stepForward()
...
//                    // LOGICAL OR
//                    Token.Operator.Logical.Or ->
//                        OpLogicalOr(x, nextRight(ExpectedBlockType.Object))
//                    // NULLISH COALESCING
//                    Token.Operator.NullishCoalescing -> {
//                        val replacement = nextRight(ExpectedBlockType.Object)
//                        val subject = x
//                        Expression { subject(it)?.takeUnless { it is Unit } ?: replacement(it) }
//                    }
//
...
//                when(nextSignificant()) {
//                    // SPREAD
//                    is Token.Operator.Spread -> return OpSpread(next(ExpectedBlockType.Object))
//                    else -> {
//                        prevSignificant()
//                        stepForward()
//                    }
...
//    } else buildList {
//        do {
//            add(parseStatement(null, emptyList(),blockType = ExpectedBlockType.Object))
...
//    val onTrue = parseStatement(null, bContext, blockType = ExpectedBlockType.Block)
//
//    syntaxCheck(nextSignificant() is Token.Operator.Colon) {
...
//        condition = condition,
//        onTrue = onTrue,
//        onFalse = parseStatement(null, bContext, blockType = ExpectedBlockType.Block),
//        expressible = true
//    )
//}
//
...
//                val expr = parseStatement(null, blockContext, blockType = ExpectedBlockType.None)
//
...
//                ) {
//                    val value = parseStatement(null, blockContext, blockType = ExpectedBlockType.Object)
//                    val name = when (expr){
...
//            }
//            do {
//                add(parseStatement(null, blockContext, blockType = type))
